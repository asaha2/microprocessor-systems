...
void SPI_Init1(void){
  ...
  // HAL_GPIO_WritePin(NUCLEO_SPI_GPIO_PORT, NUCLEO_SPI_CS_PIN, GPIO_PIN_SET);
	...
	GPIO_InitStructure_2.Pin = GPIO_PIN_11;
	GPIO_InitStructure_2.Pull = GPIO_PULLDOWN;
...
void SPI_Init2(){
	...
	/* SPI SCK pin configuration */
  GPIO_InitStructure_3.Pin = GPIO_PIN_10;
	GPIO_InitStructure_3.Alternate = GPIO_AF6_SPI3;
	GPIO_InitStructure_3.Mode = GPIO_MODE_AF_PP;
	GPIO_InitStructure_3.Pull = GPIO_PULLDOWN;
	GPIO_InitStructure_3.Speed = GPIO_SPEED_FREQ_MEDIUM;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStructure_3);

  /* SPI  MOSI pin configuration */
  GPIO_InitStructure_3.Pin =  GPIO_PIN_12;
	GPIO_InitStructure_3.Alternate = GPIO_AF6_SPI3;
	GPIO_InitStructure_3.Mode = GPIO_MODE_AF_PP;
	GPIO_InitStructure_3.Pull = GPIO_NOPULL;
	GPIO_InitStructure_3.Speed = GPIO_SPEED_FREQ_MEDIUM;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStructure_3);

  /* SPI MISO pin configuration */
  GPIO_InitStructure_3.Pin = GPIO_PIN_11;
	GPIO_InitStructure_3.Alternate = GPIO_AF6_SPI3;
	GPIO_InitStructure_3.Mode = GPIO_MODE_AF_PP;
	GPIO_InitStructure_3.Pull = GPIO_NOPULL;
	GPIO_InitStructure_3.Speed = GPIO_SPEED_FREQ_MEDIUM;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStructure_3);
	...
	/* Configure SPI nSS pin as output push-pull */ 
	GPIO_InitStructure_3.Pin = GPIO_PIN_4;
	GPIO_InitStructure_3.Pull = GPIO_PULLUP;
	GPIO_InitStructure_3.Mode = GPIO_MODE_INPUT;
	GPIO_InitStructure_3.Speed = GPIO_SPEED_FREQ_MEDIUM;
	HAL_GPIO_Init(GPIOA, &GPIO_InitStructure_3);
  ...
  SpiHandle_2.Init.TIMode 						= SPI_TIMODE_DISABLED;
  SpiHandle_2.Init.Mode 							= SPI_MODE_SLAVE;
	if(HAL_SPI_Init(&SpiHandle_3) != HAL_OK) printf ("ERROR: Error in initialising SPI1 \n");
